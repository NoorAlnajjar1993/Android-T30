package com.dominate.thirtySecondsChallenge.base.dialogs
...
object DialogsUtil {
    ...
    fun showDatePickerDialog(
        ...
        @ColorRes positiveBtnTextColor: Int = R.color.colorAccent,
        ...
        if (isExpiry == true) {
            val defaultDate = Date(minDate ?: 0)
            val defaultTime = DateTimeUtil.incrementDateByYear(defaultDate, 1)
            val calendar = Calendar.getInstance()
            calendar.time = defaultTime
            dialog.updateDate(
    ...
    fun showTimePickerDialog(
        ...
        hasNegativeBtn: Boolean = true,
        @StringRes negativeBtnText: Int = R.string.cancel,
        @ColorRes negativeBtnTextColor: Int = R.color.colorAccent,
        hasPositiveBtn: Boolean = true,
        @StringRes positiveBtnText: Int = R.string.select,
        @ColorRes positiveBtnTextColor: Int = R.color.colorAccent
    ) {
        ...
        mTimePicker =
            TimePickerDialog(context, listener, hour, minute, is24HourView) //Yes 24 hour time
