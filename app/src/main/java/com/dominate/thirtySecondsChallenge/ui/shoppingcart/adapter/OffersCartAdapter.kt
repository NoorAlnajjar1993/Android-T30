...
import com.dominate.thirtySecondsChallenge.databinding.RowOffersCartBinding
...
class OffersCartAdapter @Inject constructor(

) :
    BaseAdapter<OffersResponseModel, OffersCartAdapter.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)

        val view = DataBindingUtil.inflate<RowOffersCartBinding>(
            inflater,
            R.layout.row_offers_cart, parent, false
        )
    ...
    class ViewHolder(val binding: RowOffersCartBinding) :
