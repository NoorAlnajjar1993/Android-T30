...
import com.dominate.thirtySecondsChallenge.databinding.RowAchievementsBinding
import com.dominate.thirtySecondsChallenge.utils.extensions.onClick

class AchievementAdapter constructor(context: Context, typeLayout: Int, flag: Int) :
    BaseBindingRecyclerViewAdapterAny<BadgesResponseModel>(context) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): BaseViewHolder<BadgesResponseModel> {
        return when (viewType) {
            VIEW_TYPE_LAYOUT_HORIZONTAL -> {
                val binding = RowAchievementsBinding.inflate(
    ...
    inner class ViewHolder(private val binding: RowAchievementsBinding) :
        BaseViewHolder<BadgesResponseModel>(binding.root) {

        override fun bind(item: BadgesResponseModel) {
            binding.item = item
    ...
    inner class ViewHolderWallpaper(private val binding: RowAchievementsBinding) :
        BaseViewHolder<BadgesResponseModel>(binding.root) {
